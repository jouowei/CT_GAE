...
class Shippment(db.Model):
    ...
    def __init__(self, ship_ID, contact_info, ship_area, ship_district, driver, car_type, car_ID, is_elevator, floors_byhand, amount_collect, comment):
...
class ShippmentSchema(ma.Schema):
    class Meta:
        # Fields to expose
        fields = ('ship_ID', 'contact_info', 'updated_at', 'ship_datetime', 'ship_area', 'ship_district', 'driver', 'car_type', 'car_ID', 'is_elevator', 'floors_byhand', 'amount_collect', 'comment')